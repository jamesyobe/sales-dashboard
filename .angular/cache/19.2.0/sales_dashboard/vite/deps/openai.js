...
var AbstractPage = class {
  ...
  getNextPage() {
    return __async(this, null, function* () {
      ...
      return yield __classPrivateFieldGet2(this, _AbstractPage_client, "f").requestAPIList(this.constructor, nextOptions);
    });
  }
  iterPages() {
    return __asyncGenerator(this, null, function* () {
...
function debug(action, ...args) {
  if (typeof process !== "undefined" && process?.env?.["DEBUG"] === "true") {
    const modifiedArgs = args.map((arg) => {
      ...
      if (arg["headers"]) {
        const modifiedArg2 = __spreadProps(__spreadValues({}, arg), {
          headers: __spreadValues({}, arg["headers"])
        });
      ...
      for (const header in arg) {
        if (SENSITIVE_HEADERS.has(header.toLowerCase())) {
          modifiedArg ?? (modifiedArg = __spreadValues({}, arg));
...
var Messages = class extends APIResource {
  list(completionId, query = {}, options) {
    ...
    return this._client.getAPIList(`/chat/completions/${completionId}/messages`, ChatCompletionStoreMessagesPage, __spreadValues({
      query
    }, options));
  }
};
...
var Completions = class extends APIResource {
  ...
  update(completionId, body, options) {
    return this._client.post(`/chat/completions/${completionId}`, __spreadValues({
      body
    }, options));
  }
  list(query = {}, options) {
    ...
    return this._client.getAPIList("/chat/completions", ChatCompletionsPage, __spreadValues({
      query
    }, options));
  }
  /**
...
var Transcriptions = class extends APIResource {
  create(body, options) {
    return this._client.post("/audio/transcriptions", multipartFormRequestOptions(__spreadProps(__spreadValues({
      body
    }, options), {
      __metadata: {
        model: body.model
...
var Translations = class extends APIResource {
  create(body, options) {
    return this._client.post("/audio/translations", multipartFormRequestOptions(__spreadProps(__spreadValues({
      body
    }, options), {
      __metadata: {
        model: body.model
...
var EventStream = class {
  ...
  emitted(event) {
    ...
    return __async(this, null, function* () {
      __classPrivateFieldSet3(this, _EventStream_catchingPromiseCreated, true, "f");
      yield __classPrivateFieldGet3(this, _EventStream_endPromise, "f");
    });
  }
  _emit(event, ...args) {
  ...
  if (!params || !hasAutoParseableInput(params)) {
    return __spreadProps(__spreadValues({}, completion), {
      choices: completion.choices.map((choice) => __spreadProps(__spreadValues({}, choice), {
        message: __spreadValues(__spreadProps(__spreadValues({}, choice.message), {
          parsed: null
...
function parseChatCompletion(completion, params) {
  const choices = completion.choices.map((choice) => {
    ...
    return __spreadProps(__spreadValues({}, choice), {
      message: __spreadProps(__spreadValues(__spreadValues({}, choice.message), choice.message.tool_calls ? {
